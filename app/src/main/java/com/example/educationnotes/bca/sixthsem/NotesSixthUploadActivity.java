...
import com.example.educationnotes.bca.fifthsem.NotesFifthUploadActivity;
...
public class NotesSixthUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_sixth_upload);
        ...
        back.setOnClickListener(view -> {
            Intent intent = new Intent(NotesSixthUploadActivity.this, BcaActivity.class);
    ...
    private void uploadPdfToFirebase(Uri pdfUri) {
        ...
        StorageReference reference = storageReference.child("BCA/Sixth/Notes/" + System.currentTimeMillis() + ".pdf");
        reference.putFile(pdfUri)
                ...
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(NotesSixthUploadActivity.this, "File upload failed", Toast.LENGTH_SHORT).show();
                });
    }
    private void savePdfUrlToDatabase(String pdfUrl, String pdfName) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance("https://bca-2023-default-rtdb.firebaseio.com/").getReference("BCA/Sixth-Sem/Notes");
        ...
        if (key != null) {
            ...
            databaseRef.child(key).setValue(uploadpdf)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(NotesSixthUploadActivity.this, "PDF uploaded and URL saved in database", Toast.LENGTH_SHORT).show();
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(NotesSixthUploadActivity.this, "Failed to save PDF URL in database", Toast.LENGTH_SHORT).show());
        }
    }
}