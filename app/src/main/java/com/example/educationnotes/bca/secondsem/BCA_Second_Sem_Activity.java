...
import com.example.educationnotes.bca.firstsem.eBooksFragment;
import com.example.educationnotes.bca.firstsem.questionPapersFragment;
import com.example.educationnotes.bca.firstsem.textNotesFragment;
import com.google.android.material.tabs.TabLayout;

public class BCA_Second_Sem_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bca_second_sem);

        TabLayout tabLayout = findViewById(R.id.tabLayout);
        ViewPager viewPager = findViewById(R.id.viewPager);

        // Create an instance of your custom FragmentPagerAdapter
        BCA_Second_Sem_Activity.PagerAdapter pagerAdapter = new BCA_Second_Sem_Activity.PagerAdapter(getSupportFragmentManager());
    ...
    private static class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new TextNotesSecondFragment();
                case 1:
                    return new EBooksSecondFragment();
                case 2:
                    return new QuestionPapersSecondFragment();
                default:
                    return null;
            }
        }
