...
import com.example.educationnotes.bca.firstsem.EBooksUploadActivity;
...
public class EBooksSecondUploadActivity extends AppCompatActivity {

    EditText ebookPdf;
    Button uploadEBook, back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ebooks_second_upload);

        ebookPdf = findViewById(R.id.ebook_pdf_name);
        back = findViewById(R.id.back);
        uploadEBook = findViewById(R.id.upload_ebook_pdf);
        ...
        back.setOnClickListener(view -> {
            Intent intent = new Intent(EBooksSecondUploadActivity.this, BcaActivity.class);
    ...
    private void uploadPdfToFirebase(Uri pdfUri) {
        ...
        String pdf_name = ebookPdf.getText().toString();
        StorageReference reference = storageReference.child("BCA/Second/EBook/" + System.currentTimeMillis() + ".pdf");
        reference.putFile(pdfUri)
                ...
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(EBooksSecondUploadActivity.this, "File upload failed", Toast.LENGTH_SHORT).show();
                });
    }
    private void savePdfUrlToDatabase(String pdfUrl, String pdfName) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance("https://bca-2023-default-rtdb.firebaseio.com/").getReference("BCA/Second-Sem/EBooks");
        ...
        if (key != null) {
            ...
            databaseRef.child(key).setValue(uploadpdf)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(EBooksSecondUploadActivity.this, "PDF uploaded and URL saved in database", Toast.LENGTH_SHORT).show();
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(EBooksSecondUploadActivity.this, "Failed to save PDF URL in database", Toast.LENGTH_SHORT).show());
        }
    }
}