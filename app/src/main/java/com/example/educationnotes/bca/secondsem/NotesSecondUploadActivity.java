...
public class NotesSecondUploadActivity extends AppCompatActivity {
    EditText notesPdf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_second_upload);
        ...
        back.setOnClickListener(view -> {
            Intent intent = new Intent(NotesSecondUploadActivity.this, BcaActivity.class);
    ...
    private void uploadPdfToFirebase(Uri pdfUri) {
        ...
        StorageReference reference = storageReference.child("BCA/Second/Notes/" + System.currentTimeMillis() + ".pdf");
        reference.putFile(pdfUri)
                ...
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(NotesSecondUploadActivity.this, "File upload failed", Toast.LENGTH_SHORT).show();
                });
    }
    private void savePdfUrlToDatabase(String pdfUrl, String pdfName) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance("https://bca-2023-default-rtdb.firebaseio.com/").getReference("BCA/Second-Sem/Notes");
        ...
        if (key != null) {
            ...
            databaseRef.child(key).setValue(uploadpdf)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(NotesSecondUploadActivity.this, "PDF uploaded and URL saved in database", Toast.LENGTH_SHORT).show();
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(NotesSecondUploadActivity.this, "Failed to save PDF URL in database", Toast.LENGTH_SHORT).show());
        }
    }
}