...
public class QuestionPapersUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_papers_upload);
        ...
        back.setOnClickListener(view -> {
            Intent intent = new Intent(QuestionPapersUploadActivity.this, BcaActivity.class);
    ...
    private void uploadPdfToFirebase(Uri pdfUri) {
        ...
        StorageReference reference = storageReference.child("BCA/First/Question-Papers/" + System.currentTimeMillis() + ".pdf");
        reference.putFile(pdfUri)
                ...
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(QuestionPapersUploadActivity.this, "File upload failed", Toast.LENGTH_SHORT).show();
                });
    }
    private void savePdfUrlToDatabase(String pdfUrl, String pdfName) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance("https://bca-2023-default-rtdb.firebaseio.com/").getReference("BCA/First-Sem/Question-Papers");
        ...
        if (key != null) {
            ...
            databaseRef.child(key).setValue(uploadpdf)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(QuestionPapersUploadActivity.this, "PDF uploaded and URL saved in database", Toast.LENGTH_SHORT).show();
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(QuestionPapersUploadActivity.this, "Failed to save PDF URL in database", Toast.LENGTH_SHORT).show());
        }
    }
}