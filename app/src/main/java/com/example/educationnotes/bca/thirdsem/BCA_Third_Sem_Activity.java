...
public class BCA_Third_Sem_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bca_third_sem);

        TabLayout tabLayout = findViewById(R.id.tabLayout);
        ViewPager viewPager = findViewById(R.id.viewPager);

        // Create an instance of your custom FragmentPagerAdapter
        BCA_Third_Sem_Activity.PagerAdapter pagerAdapter = new BCA_Third_Sem_Activity.PagerAdapter(getSupportFragmentManager());
    ...
    private static class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new TextNotesThirdFragment();
                case 1:
                    return new EBooksThirdFragment();
                case 2:
                    return new QuestionPapersThirdFragment();
                default:
                    return null;
            }
        }
