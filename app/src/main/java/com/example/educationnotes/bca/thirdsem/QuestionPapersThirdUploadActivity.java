...
public class QuestionPapersThirdUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_papers_third_upload);
        ...
        back.setOnClickListener(view -> {
            Intent intent = new Intent(QuestionPapersThirdUploadActivity.this, BcaActivity.class);
    ...
    private void uploadPdfToFirebase(Uri pdfUri) {
        ...
        StorageReference reference = storageReference.child("BCA/Third/Question-Papers/" + System.currentTimeMillis() + ".pdf");
        reference.putFile(pdfUri)
                ...
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(QuestionPapersThirdUploadActivity.this, "File upload failed", Toast.LENGTH_SHORT).show();
                });
    }
    private void savePdfUrlToDatabase(String pdfUrl, String pdfName) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance("https://bca-2023-default-rtdb.firebaseio.com/").getReference("BCA/Third-Sem/Question-Papers");
        ...
        if (key != null) {
            ...
            databaseRef.child(key).setValue(uploadpdf)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(QuestionPapersThirdUploadActivity.this, "PDF uploaded and URL saved in database", Toast.LENGTH_SHORT).show();
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(QuestionPapersThirdUploadActivity.this, "Failed to save PDF URL in database", Toast.LENGTH_SHORT).show());
        }
    }
}