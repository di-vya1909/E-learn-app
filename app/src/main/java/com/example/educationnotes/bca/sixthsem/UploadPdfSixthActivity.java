...
public class UploadPdfSixthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pdf_sixth);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(UploadPdfSixthActivity.this, "Selected: " + selectedOption, Toast.LENGTH_SHORT).show();
                ...
                if(selectedOption.equals("Text Notes")) {
                    ...
                    Toast.makeText(UploadPdfSixthActivity.this, "Select PDF Type", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void openNotesUploadActivity() {
        Intent intent = new Intent(UploadPdfSixthActivity.this, NotesSixthUploadActivity.class);
        startActivity(intent);
        finish();
    }

    private void openEBooksUploadActivity() {
        Intent intent = new Intent(UploadPdfSixthActivity.this, EBooksSixthUploadActivity.class);
        startActivity(intent);
        finish();
    }

    private void openQuestionPapersUploadActivity() {
        Intent intent = new Intent(UploadPdfSixthActivity.this, QuestionPapersSixthUploadActivity.class);
        startActivity(intent);
        finish();
    }
}